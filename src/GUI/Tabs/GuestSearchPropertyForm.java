...
import src.GUI.Menu.PropertyViewer;
...
public class GuestSearchPropertyForm extends GUI {
	...
	private PropertyViewer showProperty;

	public GuestSearchPropertyForm() {
		super();
		showProperty = new PropertyViewer();
		...
		searchButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ArrayList<Property> list = rentalDAO.searchPropety(typeBox.getSelectedItem().toString(),
						Integer.parseInt(bedroomsBox.getSelectedItem().toString()),
						Integer.parseInt(bathroomsBox.getSelectedItem().toString()), furnishedBox.isSelected(),
						quadrantBox.getSelectedItem().toString());
				showProperty.display(list);
			}
		});
